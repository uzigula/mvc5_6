...
namespace YoVoy.Web
{
    public class EmailService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            ...
            mail.From = new MailAddress("uzi4test@gmail.com", "YoVoy administracion de cuentas");
            ...
            smtpClient.Port = 587;
            // si se requiere autenticacion
            smtpClient.UseDefaultCredentials = false;
            smtpClient.EnableSsl = true;
            smtpClient.DeliveryMethod = SmtpDeliveryMethod.Network;
            smtpClient.Credentials = new NetworkCredential("uzi4test@gmail.com", "4T3st1ng2015");
